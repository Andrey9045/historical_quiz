...
## Подготовка к запуску ботов.
txt. файлы с вопросами кладите в папку quiz, которая находится в корне проектв.
...
```
python bot_telegram.py (Название файла с вопросами(Обязательно))
```

```
python bot_vk.py (Название файла с вопросами(Обязательно))
```
